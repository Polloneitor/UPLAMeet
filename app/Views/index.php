    ...
    <div class="container-fluid" style="background-color:rgb(60, 79, 119)">
        ...
        <div class="container" style="background-color:white">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid"style="background-color:orange ;border-radius:30px">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="perfil.html"><h3 style="color: white;">Perfil</h3></a>
                      </li>
                      <li class="nav-item">
              ...
              <div class="row">                    
                <img src="images/blanco.jpg"width="10" height="100">
              </div>
              <div class="row">
                <div class="col-1"style="background-color:white">
                    <img src="images/blanco.jpg"width="10" height="10">
                </div>
                <div class="col"style="background-color:blue">
                    <div class="card" style="width: 13rem;">
                        <img src="images/space.gif" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col"style="background-color:orange">
                    <div class="card" style="width: 13rem;">
                        <img src="images/space2.gif" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col"style="background-color:purple">
                    <div class="card" style="width: 13rem;">
                        <img src="images/space4.gif" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col"style="background-color:red">
                    <div class="card" style="width: 13rem;">
                        <img src="images/space3.gif" class="card-img-top" alt="...">
                        <div class="card-body">
